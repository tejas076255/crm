...
export const RATE_LIMITS = {
  ...
  /** AI auto-reply generation, per account. Set to 100,000/min to allow unlimited automated responses without throttling. */
  aiAutoReplyAccount: { limit: 100_000, windowMs: 60_000 },
} as const;
