...
export default function AutomationsPage() {
  ...
  const { canAutomate, profileLoading } = useAuth()
  ...
  // Pro gate: no-code automations are a pro-and-up surface, matching the
  // server-side requirePlan('pro') on /api/automations/*. Deep links from
  // a Free account land on the upgrade prompt, not a dead feature list.
  if (!profileLoading && !canAutomate) {
    return <UpgradeGate requires="pro" />
  }
