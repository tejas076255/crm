...
export const metadata: Metadata = {
  title: {
    default: "Yaari CRM — WhatsApp CRM",
    template: "%s — Yaari CRM",
  },
  description:
    "Yaari CRM — WhatsApp CRM for your team. Shared inbox, contacts, sales pipelines, broadcasts, no-code automations, and AI reply assistant.",
  robots: {
    index: true,
    follow: true,
    googleBot: {
