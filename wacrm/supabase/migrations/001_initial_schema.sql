...
-- Supabase exposes gen_random_uuid() reliably across hosted projects.
CREATE EXTENSION IF NOT EXISTS "pgcrypto";

-- Keep the legacy migration defaults compatible with projects where
-- uuid-ossp is unavailable or installed outside the search path.
